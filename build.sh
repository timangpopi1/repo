...
build_kernel() {
    git clone --quiet -j64 --depth=1 -b gcc8-201903-A https://github.com/najahiiii/aarch64-linux-gnu.git gcc
    git clone --quiet -j64 --depth=1 -b master https://github.com/arter97/arm-eabi-5.1.git gcc32
