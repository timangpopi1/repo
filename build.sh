...
git clone -j$(nproc --all) --single-branch https://gitlab.com/fadlyas07/clang-llvm --depth=1
...
export PATH="$(pwd)/clang-llvm/bin:$PATH" && main_env="ARCH=arm64 CC=clang CROSS_COMPILE=aarch64-linux-gnu-"
