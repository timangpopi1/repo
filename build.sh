...
export PATH="$(pwd)/gcc/bin:$(pwd)/clang/bin:$PATH" export KBUILD_BUILD_USER="" && export KBUILD_BUILD_HOST=""
BUILD_ENV="ARCH=arm64 CC=clang CLANG_TRIPLE=aarch64-linux-gnu- CROSS_COMPILE=aarch64-linux-android-"
