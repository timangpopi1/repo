...
build_kernel() {
    git clone --quiet --depth=1 -b linaro https://github.com/timangpopi1/arm64-gcc-linaro-4.9-2016 gcc
    ...
    CROSS_COMPILE=aarch64-linux-gnu- CROSS_COMPILE_ARM32=arm-eabi-
}
