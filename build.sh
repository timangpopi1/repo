...
build_clang() {
    git clone --quiet --depth=1 https://github.com/najahiiii/aarch64-linux-gnu.git -b gcc8-201903-A gcc
    ...
    make -j$(nproc) -l$(nproc) ARCH=arm64 O=out CROSS_COMPILE=aarch64-linux-gnu- CROSS_COMPILE_ARM32=arm-eabi-
}
