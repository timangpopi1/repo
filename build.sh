...
if [[ "$2" == "clang" ]] ; then
    git clone --quiet --depth=1 https://github.com/kdrag0n/proton-clang proton
    function build_now() {
    ...
    git clone --quiet --depth=1 https://github.com/LineageOS/android_prebuilts_gcc_linux-x86_aarch64_aarch64-linux-android-4.9 -b lineage-18.0 gcc
    git clone --quiet --depth=1 https://github.com/LineageOS/android_prebuilts_gcc_linux-x86_arm_arm-linux-androideabi-4.9 -b lineage-18.0 gcc32
    function build_now() {
